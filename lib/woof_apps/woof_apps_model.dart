...
class WoofAppsModel extends FlutterFlowModel {
  ...
  String editMSGImg = 'qwer';

  String editLastmsg = 'qwert';

  DateTime? editTsMSG;

  DocumentReference? imgImgRef;
  ...
  // Stores action output result for [Bottom Sheet - changeChatImage] action in Image widget.
  String? q123;
  ...
  // Stores action output result for [Bottom Sheet - changeImgeDisplayImage] action in Image widget.
  String? imgoutput;
  // State field(s) for TextField widget.
