...
import 'oldversion_model.dart';
export 'oldversion_model.dart';

class OldversionWidget extends StatefulWidget {
  const OldversionWidget({Key? key}) : super(key: key);

  @override
  _OldversionWidgetState createState() => _OldversionWidgetState();
}

class _OldversionWidgetState extends State<OldversionWidget> {
  late OldversionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OldversionModel());
  }
    ...
    return Align(
      ...
      child: StreamBuilder<List<VersionRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<VersionRecord> cardTaskDetailsVersionRecordList = snapshot.data!;
          final cardTaskDetailsVersionRecord =
              cardTaskDetailsVersionRecordList.isNotEmpty
                  ? cardTaskDetailsVersionRecordList.first
                  : null;
          return Container(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await launchURL(isAndroid
                              ? cardTaskDetailsVersionRecord!.linkAndroid!
                              : cardTaskDetailsVersionRecord!.linkIOS!);
                        },
                        text: 'Update the app',
